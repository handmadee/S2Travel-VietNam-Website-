            ...
            <div class="container pt-lg-3">
                <div class="row align-items-lg-center">
                    <div class="col-12 col-md-7 about-content pr-lg-5  " data-aos="fade-right" data-aos-delay="100">
                        ...
                        <div class="mb-2 brief mx-auto"  >Công Ty TNHH S2 Travel VietNam là một đơn vị tổ chức tour chuyên nghiệp với Ban lãnh đạo có trên 15 năm kinh nghiệm trong lĩnh vực lữ hành, cùng đội ngũ nhân viên trẻ, năng động, giàu tính sáng tạo và nhiệt huyết trong công việc. Với chúng tôi, mỗi cá nhân là một mắt xích tạo nên một tập thể vững mạnh, hướng tới mục tiêu chung là mang lại sự hài lòng tuyệt đối đến quý khách hàng.

                            Với phương châm "Sự hài lòng của Quý khách hàng là thành công của Chúng tôi", Du lịch Hoa Phượng Tím đang nỗ lực không ngừng nâng cao chất lượng dịch vụ, đa dạng hóa sản phẩm du lịch nhằm tạo nên những trải nghiệm tốt nhất cho Quý du khách trong và ngoài nước.
                            ...
                            Du lịch Hoa Phượng Tím cam kết là một người bạn đồng hành tận tụy, cung cấp dịch vụ chuẩn chỉnh và chất lượng nhất cho quý khách, cùng quý khách khám phá những điểm đến hấp dẫn trong và ngoài nước.
                        </div>
                    </div>
                    <div class="col-12 col-md-5 about-hotline pl-lg-5" data-aos="fade-left" data-aos-delay="100">
                        <div class="hotline d-flex align-items-center" onclick="tel:02633 702 113">
                            <img src={phone} alt="about-hotline-background" />
                            <div class="text">
                                <p class="mb-0">Hotline tư vấn</p>
                                <a class="utgod" href="tel:02633 702 113">02633 702 113</a>
                            </div>
                        </div>
                    </div>
