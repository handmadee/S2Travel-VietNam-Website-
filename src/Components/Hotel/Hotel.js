...
function Hotel() {
    ...
    const ListProduct = () => {
        const Tour = ResortTour && ResortTour.length > 4 ? ResortTour.slice(0, 4) : ResortTour
        return (
            Tour.map((item, index) => {
    ...
    return (
        <div className='home-product tripHome recent-holidays my-4 my-sm-5 pt-5' data-aos="fade-up" data-aos-delay="100">
            <Container>
                <h2 className='fw-semibold'>Các Khách Sạn Nổi Bật </h2>
                <p className='mb-4 mb-sm-5'>Hè Tới Rồi Đi Chơi Thôi !</p>
                <div className='row g-4'>
                    {/* Content  */}
                    <div className="wrap list-product-home">
                        <ListProduct />
                        <button className="btn_vip btnViewAll text-center my-3 my-lg-4" data-aos="fade-up" data-aos-delay="100"><a className="more-all" href="/HotelTour">Xem tất cả</a> </button>
