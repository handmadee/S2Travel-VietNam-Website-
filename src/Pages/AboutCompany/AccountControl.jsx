                    ...
                    <div class="col-md-9 col-xs-12">
                        <div class="s35_m">
                            ...
                            <div class="s35_b">
                                ...
                                <p>Website https://www.s2travelvietnam.vn/ chuyên giới thiệu, cung cấp các tour du thuyền tới du khách trong và ngoài nước. </p>
                                <h2>2. Giao nhận và vận chuyển</h2>
                                <p>Sau khi đặt mua đơn hàng và thanh toán 100% giá trị đơn hàng, https://www.s2travelvietnam.vn/ sẽ gửi thông tin về đơn hàng đến địa chỉ email khách hàng đã đăng ký khi đặt mua đơn hàng.</p>
                                <p>Trường hợp khách hàng thay đổi email sử dụng sau khi thanh toán thành công và thông tin đơn hàng đã được gửi đi, https://www.s2travelvietnam.vn/ sẽ không chịu trách nhiệm trong trường hợp mất mát thông tin đơn hàng.</p>
                                ...
                                <p style={{ marginLeft: '20px' }}>
                                    - Gửi thông tin tới địa chỉ email: <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="ef87809b9d80af8b9a9b879a968a81878e83808188c18c8082">[booking@s2travelvietnam.vn	]</a>
                                </p>
                                ...
                                <p>Sản phẩm giao dịch giữa https://www.s2travelvietnam.vn/ và khách hàng là dịch vụ, nên không áp dụng chính sách bảo hành/bảo trì.</p>
                                ...
                                <p style={{ marginLeft: '20px' }}>- Gửi yêu cầu theo form “liên hệ” trên website</p>
                                <p style={{ marginLeft: '20px' }}>
                                    - Gửi thông tin tới địa chỉ email: <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="ef9c8e838a9caf8b9a9b879a968a81878e83808188c18c8082">[booking@s2travelvietnam.vn]</a>
                                </p>
                                <p style={{ marginLeft: '20px' }}>- Gọi điện thoại tới số điện thoại: 0971.691.414  hoặc liên hệ trực tiếp với nhân viên phụ trách đơn hàng của quý khách.</p>
                                <p>
                                ...
                                <p>Cung cấp đầy đủ thông tin cá nhân có liên quan khi sử dụng dịch vụ trên Website https://www.s2travelvietnam.vn/ như: Họ tên; Số điện thoại liên lạc; Email và chịu trách nhiệm về chính xác của các thông tin này. Duthuyenhalong.com không chịu trách nhiệm trong trường hợp Khách hàng cung cấp thông tin không chính xác.</p>
                                <p>Tuyệt đối không sử dụng bất kỳ chương trình, công cụ hay hình thức nào khác để can thiệp vào hệ thống hay làm thay đổi cấu trúc dữ liệu website. Nghiêm cấm việc phát tán, truyền bá hay cổ vũ cho bất kỳ hoạt động nào nhằm can thiệp, phá hoại hay xâm phạm hệ thống Website https://www.s2travelvietnam.vn/. Mọi vi phạm sẽ bị xử lý theo quy định của pháp luật.</p>
                                <p>Sẽ tự chịu trách nhiệm về bảo mật và lưu giữ xác nhận đặt phòng của mình khi sử dụng sản phẩm, dịch vụ được mua trên website https://www.s2travelvietnam.vn/ . Có trách nhiệm thông báo kịp thời cho website https://www.s2travelvietnam.vn/ về những hành vi sử dụng trái phép, lạm dụng xác nhận đặt phòng của mình để hai bên cùng hợp tác xử lý.</p>
                                <p>Cam kết những thông tin cung cấp cho website https://www.s2travelvietnam.vn/ là chính xác và hoàn chỉnh.</p>
                                <p>Cam kết, đồng ý không sử dụng dịch vụ của website https://www.s2travelvietnam.vn/ vào những mục đích bất hợp pháp, không hợp lý, lừa đảo, đe doạ, thăm dò thông tin bất hợp pháp, phá hoại, tạo ra và phát tán virus gây hư hại tới hệ thống, cấu hình, truyền tải thông tin của website https://www.s2travelvietnam.vn/ hay sử dụng dịch vụ của mình vào mục đích phá hoại, tạo những đơn đặt hàng giả, kể cả phục vụ cho việc phán đoán nhu cầu thị trường. Trong trường hợp vi phạm thì Khách hàng và/hoặc Nhà cung cấp phải chịu trách nhiệm về các hành vi của mình trước pháp luật.</p>
                                <p>Cam kết không được thay đổi, chỉnh sửa, ghép, sao chép, truyền bá, phân phối, cung cấp và tạo những công cụ tương tự của dịch vụ do website https://www.s2travelvietnam.vn/ cung cấp cho một bên thứ ba, nếu không được sự đồng ý của https://www.s2travelvietnam.vn/.</p>
                                <p>Không được hành động gây mất uy tín của https://www.s2travelvietnam.vn/ dưới mọi hình thức như tuyên truyền, phổ biến những thông tin sai sự thật bất lợi cho uy tín của website https://www.s2travelvietnam.vn/. </p>
                                <h2>6. Phương thức thanh toán</h2>
                                <p>Sau khi đăng ký sử dụng dịch vụ trên website https://www.s2travelvietnam.vn/, khách hàng vui lòng thanh toán theo một trong hai phương thức sau:</p>
                                <p style={{ marginLeft: '20px' }}>- Chuyển khoản qua ngân hàng: sau khi đặt hàng, khách hàng chuyển khoản số tiền đơn hàng vào tài khoản của website https://www.s2travelvietnam.vn/ tại các hệ thống ngân hàng.</p>
                                <p>
                                    <br />
                                </p>
                            </div>
